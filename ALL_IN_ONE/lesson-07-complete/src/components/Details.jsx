    ...
    <section className="h-full">
      <div className="h-full rounded border border-gray-200 bg-white shadow-sm">
        ...
        <div className="flex gap-2 border-t border-gray-200 px-4 py-3">
          <button
            type="button"
            className="rounded border border-gray-300 px-3 py-2 text-sm font-semibold text-white hover:bg-gray-50"
          >
            Copy email
          </button>
          <button
            type="button"
            className="rounded border border-blue-600 px-3 py-2 text-sm font-semibold text-white hover:bg-blue-50"
          >
            Open map
          </button>
        </div>
