        ...
        <div className="space-y-4 p-4">
          <form id="frm-filter" className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2" aria-label="Category filters">
                {['All', 'Academic', 'Wellness', 'Financial', 'Tech'].map((label) => (
                  <button
                    key={label}
                    type="button"
                    className="rounded border border-sky-600 px-3 py-1 text-xs font-semibold text-white hover:bg-sky-50"
                  >
                    {label}
                  </button>
                ))}
            ...
            <div className="flex gap-2">
              <button
                type="button"
                className="rounded bg-sky-700 border-sky-700 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-50"
              >
                Reset
              </button>
              <button
                type="submit"
                className="rounded bg-sky-700 border-sky-700 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700"
              >
                Filter
              </button>
            </div>
